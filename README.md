...
- **Secure Authentication**: User accounts are protected with `Flask-Login` and `Flask-Bcrypt` password hashing.
...
3. **Train the ML Models**
   Generate fresh, localized `.pkl` model files by running the training scripts:
   ```bash
